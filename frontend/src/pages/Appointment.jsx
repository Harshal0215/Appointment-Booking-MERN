    ...
    docInfo && (
      <div>
        <div className="flex flex-col sm:flex-row gap-4">
          <div>
            <img
              className="bg-gray-300 w-full sm:max-w-72 rounded-lg hover:shadow-xl transition duration-300"
              src={docInfo.image}
              alt=""
            />
          </div>
        ...
        <div className="sm:ml-72 sm:pl-4 font-medium text-gray-700">
          ...
          <button onClick={bookAppointment} className="bg-primary text-white text-sm font-light rounded-lg">Book an Appointment</button>
        </div>
